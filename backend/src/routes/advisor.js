  ...
  try {
    ...
    const query = `
      SELECT 
        ...
        current_savings as "Current_Savings",
        monthly_expenses as "Monthly_Expenses",
        projected_pension_amount as "Projected_Pension_Amount",
        CASE 
          WHEN risk_tolerance IS NOT NULL THEN risk_tolerance
        ...
        savings_rate as "Savings_Rate",
        debt_level as "Debt_Level",
        number_of_dependents as "Number_of_Dependents",
        education_level as "Education_Level",
        health_status as "Health_Status",
        life_expectancy_estimate as "Life_Expectancy_Estimate",
        home_ownership_status as "Home_Ownership_Status",
        contribution_amount as "Contribution_Amount",
        contribution_frequency as "Contribution_Frequency",
        employer_contribution as "Employer_Contribution",
        total_annual_contribution as "Total_Annual_Contribution",
        years_contributed as "Years_Contributed",
        investment_type as "Investment_Type",
        fund_name as "Fund_Name",
        volatility as "Volatility",
        fees_percentage as "Fees_Percentage",
        investment_experience_level as "Investment_Experience_Level",
        portfolio_diversity_score as "Portfolio_Diversity_Score",
        expected_annual_payout as "Expected_Annual_Payout",
        inflation_adjusted_payout as "Inflation_Adjusted_Payout",
        years_of_payout as "Years_of_Payout",
        survivor_benefits as "Survivor_Benefits",
        pension_type as "Pension_Type",
        withdrawal_strategy as "Withdrawal_Strategy",
        tax_benefits_eligibility as "Tax_Benefits_Eligibility",
        government_pension_eligibility as "Government_Pension_Eligibility",
        private_pension_eligibility as "Private_Pension_Eligibility",
        insurance_coverage as "Insurance_Coverage",
        financial_goals as "Financial_Goals",
        transaction_id as "Transaction_ID",
        transaction_amount as "Transaction_Amount",
        transaction_date as "Transaction_Date",
        transaction_channel as "Transaction_Channel",
        time_of_transaction as "Time_of_Transaction",
        suspicious_flag as "Suspicious_Flag",
        anomaly_score as "Anomaly_Score",
        transaction_pattern_score as "Transaction_Pattern_Score",
        previous_fraud_flag as "Previous_Fraud_Flag",
